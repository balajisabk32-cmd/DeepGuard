"""PhysNet — VENDORED, not authored here.

Source : rPPG-Toolbox (ubicomplab), neural_methods/model/PhysNet.py
Paper  : Yu et al., "Remote Photoplethysmograph Signal Measurement from Facial
         Videos using Spatio-Temporal Networks" (BMVC 2019)

A supervised BVP extractor trained against ground-truth pulse oximetry — a
different mechanism entirely from CHROM/POS, which are hand-designed chrominance
projections. It can recover signal where they cannot.
